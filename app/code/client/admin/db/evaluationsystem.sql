...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2017 at 06:11 AM
...
(3, 'C. Teaching Independent Learning', NULL),
...
(1, 1, 'The student is learning properly.'),
(2, 2, 'The student need more attention from the teacher.'),
(3, 2, 'The students must have the availability to skip homework'),
(4, 4, 'Students not responsible enough to learn on their own.');
