...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		load = function() {
			require(
				[
					'elfinder'
					, '/package/drive/js/extras/editors.default.min.js'               // load text, image editors
					, 'elFinderConfig'
	...
	require.config({
		...
		paths : {
			...
			'elfinder' : baseUrl + packagePath + 'js/elfinder.min',
	...
	if (! require.defined('elFinderConfig')) {
		define('elFinderConfig', {
			...
			defaultOpts : {
				url : baseUrl + 'dashboard/drive/finder' // connector URL (REQUIRED)
				,commandsOptions : {
					edit : {
						extraOptions : {
